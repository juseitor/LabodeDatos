...
#%% Modificar los nombres de Provincia para que no tengan tildes
...
#tienen la misma cantidad de Departamentos. Si tDepartamento_personal tiene
# la misma cantidad de filas que Departamento, entonces si.
...
C2 = """
    SELECT Provincia, Departamento, SUM (Empleados) AS "Cantidad total de empleados por departamento"
...
Cantidad_EE_por_provincia_y_departamento = db.query(C6).df()